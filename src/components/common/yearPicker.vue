...
<script>
	...
	export default {
		...
		methods: {
			...
			var selectData = this.value?[]:[{text:'',value:''}]
...
//				$('.mbsc-sc-itm-sel').css('color','#ddd');
//				if($('.mbsc-sc-itm-sel').css('color') == 'rgb(221, 221, 221)'){
//					clearInterval(time)
//				}
//			},100);
			$('.item_title_relation .mbsc-control-ev').css("background", "#f0f0f0")
...
<style type="text/css" scoped>
	.item_title_relation .mbsc-control-ev {
