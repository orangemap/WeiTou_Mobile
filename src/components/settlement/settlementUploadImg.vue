<template>
	<div class='upload-img'>
		...
		<div class='upload-image-div'>
			...
			<p class='text-center'>代理人： {{titleName}} 先生/女士</p>
...
<script>
	...
	export default {
		...
		data() {
			return {
				HeaderText:'资料上传',
				titleName:utils.cache.get('personsal').agentName,
				isIos:(!!navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/))?true:false,
				imgList:[],
				imgWidth:'',
				imgHeight:'',
				num:0,
...
<style>
.upload-img .upload-image-div #files{
	width: 8rem;
	height:2.2rem;
	opacity: 0;
	position: absolute;
