		...
		<div class="manage-contents">
			...
			<div class="content clear">
				...
				<div>	
					...
					<p class="para">您投保的“光大永明金生富贵年金保障计划（2017）”由《光大永明金生富贵年金保险》（简称“主合同”)和《光大永明附加增利金账户年金保险（万能型）》(简称“附加合同”)两款产品组合销，其中《光大永明金生富贵年金保险》是一款长期年金理财保险产品，包含生存保险金，满期保险金，身故保险金，投保人发生意外伤害豁免保险费等保险责任，保障至80周岁；《光大永明附加增利金账户年金保险（万能型）》是一款万能型年金产品，包含身故保险金和满期保险金等保险责任，该产品保费来自主合同产品所约定的自动转入附加合同个人账户中的生存保险金，并可追加保费，我们仅在第一个保单年度收取追加保费的1%作为初始费用，其余部分进入个人万能账户，本公司每日按照日结算利率结算利息，个人账户价值按结算的利息额增加，<b>请注意超过万能险最低保证利率之上的</b><b>投资收益是不确定的，结算利率以实际公布的为准</b>。请您仔细阅读产品条款，特别关注产品条款中关于责任免除的相关描述。</p>
					<p class="para">自您签收本保险合同之日起十五天内为犹豫期，如果您在犹豫期内要求退保，本公司将扣除您十元工本费及您已部分提取的附加合同账户价值后无息退还您所交纳的全部保险费(含追加保费，不含保险单生效日次日的生存保险金），保险合同自始无效。如果您在犹豫期后要求退保，本公司将退还您申请退保时的现金价值净额或个人账户价值（详见主合同第十八条、附加合同第二十六条），<b>您在犹豫期后退保可能会损失部分已交保费。</b></p>
				...
				<div class="sig">
						<p align="right">投保人签字：__________<img :src="sign" alt="" style="border-bottom:1px solid #000">	</p>
						<p align="right">日期：<input readonly type="text" style="border: none;width: 30%;border-bottom: 1px solid black;font-size: 15px;text-align: center" id="nowDate"></p>		
				</div>
				<div class="footer">
	    ...
	    methods:{
	    	...
	    	checkall(){
	    		...
	    		if(this.input_text==""){
	    			...
	    			this.$refs.alert.showMOdal('只能输入数字，且为正数')
	    		    return false
	    		}else {
	    			return true
	    		}
