	...
	<div>
		...
		<div class="main-contents">
			...
			<div class="main-contents-right">
				...
				<div class="content">
					<div>
						<h1>投保人身保险新型产品风险测评问卷(宁波)</h1>
						<div class="title">
							<p class="left">
								投保人:<input type="text" v-model="docTypeInfo.appntName">
							</p>
							<p class="right">
								投保单号:<input type="text" readonly v-model="docTypeInfo.prtNo">
							</p>
						</div>
					</div>
					<div class="titName">
					...
					<div class="question1">
						<p>1. &nbsp;&nbsp;&nbsp;您此次的投保目的:(
							<input type="text" class="kuohaoInput" maxlength="1" v-model="docTypeInfo.purpose">)
						</p>
						<ul>
					...
					<div class="question2">
						<p>2. &nbsp;&nbsp;&nbsp;您的主要收入来源:(
							<input type="text" class="kuohaoInput" maxlength="1" v-model="docTypeInfo.sourceOfIncome">)
						</p>
						<ul>
					...
					<div class="question3">
						<p>3. &nbsp;&nbsp;&nbsp;您的家庭年收入为(折合人民币):(
							<input type="text" class="kuohaoInput" maxlength="1" v-model="docTypeInfo.familySalay">)
						</p>
						<ul>
							<li>a. 20万以上</li>
							<li>b.10-20万元</li>
					...
					<div class="question4">
						<p>
							4.&nbsp;&nbsp;&nbsp;您本次所投保产品的保险期间是<input type="text" maxlength="8" v-model="docTypeInfo.insuYears" v-supportNumber>年, 交费期间是
							<input type="text" maxlength="8" v-model="docTypeInfo.payYears" v-supportNumber>年交;
						</p>
						...
						<p>
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.allPayItem_a"
							@click="click4_1('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.allPayItem_b"
							@click="click4_1('no')">否
						</span>
						</p>
						<p>
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.periodPayItem_a" @change="click4_2('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.periodPayItem_b" @change="click4_2('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.bonusItem_a" @change="click5('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.bonusItem_b" @change="click5('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.refundItem_a" @change="click6('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.refundItem_b" @change="click6('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.bnfItem_a" @change="click7('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.bnfItem_b" @change="click7('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.explainItem_a" @change="click8('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.explainItem_b" @change="click8('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.signItem_a" @change="click9('yes')">是&nbsp;&nbsp;&nbsp;&nbsp;
							b.<input type="checkbox" v-model="docTypeInfo.signItem_b" @change="click9('no')">否
						</span>
						</p>
						<p>
							<span class="chooseTit">
							...
							<span class="choose">
							a.<input type="checkbox" v-model="docTypeInfo.salayItem_a" @change="click10('yes')">40%以下
							b.<input type="checkbox" v-model="docTypeInfo.salayItem_b" @change="click10('no')">40%-80%
						</span>
						</p>
					</div>
					<!-- 投保人声明 -->
					<div class="shengming">
						...
						<div style="display:flex;justify-content:space-between;margin-top:10px;">
							<span>投保人签字:<input type="text" disabled v-model="docTypeInfo.appSign"></span>
							<span>日期:<input type="text" readonly v-model="docTypeInfo.appSignDate"></span>
						</div>
					</div>
					<!-- 客户风险承受能力等级表 -->
					<div class="table">
					...
					<div class="result">
						...
						<p class="level">该客户风险承受能力为<input type="text" v-model="docTypeInfo.riskLevel">级</p>
						<p style="display:flex;justify-content:space-between;margin-top:10px;">
							<span style="padding: 3px 0;">销售人员签字:<input type="text" disabled v-model="docTypeInfo.agentSign" style="width:75px"></span>
							<span style="padding: 3px 0;display: inline-block;height: 10px;">日期:
							<input type="text" v-model="docTypeInfo.agentSignDate" style="width:75px">
						</span>
						</p>
					</div>
		...
		<Footerbtns :is_show=false v-if="calPass" total_premium="10000.00">
			<button class="btnFoote" slot="center" @click="reportPage" :disabled="!isAgree">
				下一步
			</button>
		</Footerbtns>
		<Footerbtns :is_show=false v-if="!calPass" total_premium="10000.00">
			<button class="btnFoote" slot="center" @click="calculation" :disabled="!isAgree">
				测  评
			</button>
		</Footerbtns>
	</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			goBack() {
				//投保回退数据保存功能:保存宁波测评问卷页面
				this.NBinfo()
				console.log("保存宁波测评问卷页面")
				this.$router.push({
			...
			checkPrtNo() {
				if(isNaN(this.docTypeInfo.prtNo)) {
					return '保单号不正确,请检查.'
				}
				return '';
			},
