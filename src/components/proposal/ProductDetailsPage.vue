...
<template>
  <div>
    ...
    <div v-show="contentIsOpen">
      ...
      <div class="main-contents process" :class="LoginWidth>924?'isPc':''" v-show="loadData">
        ...
        <div v-show="showList==1">
          <ul>
            <li style="position: relative;">
              ...
              <label>
                <picker
                  v-model="insurant.relationNew"
                  :values="insurant.relationNew"
                  :items="dict.relationBenefitList"
                  code="code"
                  text="text"
              ...
              <p
                ...
                v-show="insurant.relationNew=='30'"
              >({{insurant.relToAppDesc}})</p>
            </li>
            <li :class="insurant.check_name!=''?'active':''">
              ...
              <div>
                <input
                  ...
                  v-supportLetterChinese
                  @focus="removeTestName(insurant)"
                  @blur="testName(insurant)"
                  maxlength="15"
                  placeholder="请输入姓名"
                  :readonly="insurant.memberType == '1'"
                />
                <img
                  src="../../../static/img/policy/icon_search.png"
                  @click="customerSearch(dict.global_constant.TAG_SEARCH_CUS_INSURE)"
                />
                <img
                  src="../../../static/img/policy/icon_camera.png"
                  v-if="insurant.memberType!='1'"
                  @click="cardScanning(dict.global_constant.TAG_SEARCH_CUS_INSURE,insurant.id,'-1')"
                />
                <img
                  src="../../../static/img/policy/icon_camera.png"
                  v-if="insurant.memberType=='1'"
            ...
            <li>
              ...
              <div>
                <date-picker
                  ...
                  @change="changeInsurantBirth('insurant',insurant)"
                  style="width: 85%;"
                ></date-picker>
            ...
            <li>
              ...
              <div>
                ...
                <img
                  src="../../../static/img/policy/icon_microphone.png"
                  @click="speechRec(dict.global_constant.TAG_SEARCH_CUS_INSURE)"
                />
              </div>
            </li>
          </ul>
          ...
          <ul
            v-if="false"
            v-for="(item,index) in otherInsurantList"
            class="bgul"
          >
            <li>
              <p>与投保人关系</p>
              <div style="position: relative;">
                <label style="display: flex;justify-content: space-between;width: 80%;">
                  <picker
                    v-model="item.insurant.relationNew"
                    :values="item.insurant.relationNew"
                    :items="dict.relationBenefitList"
                    code="code"
                    text="text"
              ...
              <p
                class="hideText"
                style="position: absolute;right: 30%;"
                v-if="item.insurant.relationNew == "30""
              >({{item.insurant.relToAppDesc}})</p>
            </li>
            <li :class="item.insurant.check_name!=''?'active':''">
              ...
              <div>
                <input
                  type="text"
                  v-model="item.insurant.name"
                  v-supportLetterChinese
                  @blur="testName(item.insurant)"
                  maxlength="15"
                  placeholder="请输入姓名"
                  :readonly="item.insurant.memberType == '1'"
                />
                <img
                  src="../../../static/img/policy/icon_search.png"
                  @click="customerSearch(dict.global_constant.TAG_SEARCH_CUS_INSURE,index)"
                />
                <img
                  src="../../../static/img/policy/icon_camera.png"
                  v-if="item.insurant.memberType!='1'"
                  @click="cardScanning(dict.global_constant.TAG_SEARCH_CUS_INSURE,item.id,index)"
                />
                <img
                  src="../../../static/img/policy/icon_camera.png"
                  v-if="item.insurant.memberType=='1'"
            ...
            <li>
              ...
              <div>
                <date-picker
                  v-if="item.insurant.memberType!='1'"
                  v-model="item.insurant.birthday"
                  :defaultTimeYear="defaultTime"
                  @change="changeInsurantBirth('insurant',item.insurant)"
                  style="width: 85%;"
                ></date-picker>
            ...
            <li>
              ...
              <div>
                ...
                <img
                  src="../../../static/img/policy/icon_microphone.png"
                  @click="speechRec(dict.global_constant.TAG_SEARCH_CUS_INSURE,index)"
                />
              </div>
            </li>
          </ul>
          ...
          <ul>
            <li :class="holder.check_name!=''?'active':''">
              ...
              <div>
                <input
                  ...
                  v-model="holder.name"
                  v-supportLetterChinese
                  @blur="testName(holder)"
                  maxlength="15"
                  placeholder="请输入姓名"
                  :readonly="holder.memberType == '1'"
                />
                <img
                  src="../../../static/img/policy/icon_search.png"
                  @click="customerSearch(dict.global_constant.TAG_SEARCH_CUS_APPLICANT)"
                />
                <img
                  src="../../../static/img/policy/icon_camera.png"
                  v-if="holder.memberType!='1'"
                  @click="cardScanning(dict.global_constant.TAG_SEARCH_CUS_APPLICANT,holder.id)"
                />
            ...
            <li>
              ...
              <div>
                <date-picker
                  ...
                  :defaultTimeYear="defaultTime"
                  @change="changeInsurantBirth('holeder')"
                  style="width: 85%;"
                ></date-picker>
            ...
            <li>
              ...
              <div>
                ...
                <img
                  src="../../../static/img/policy/icon_microphone.png"
                  @click="speechRec(dict.global_constant.TAG_SEARCH_CUS_APPLICANT)"
                />
              </div>
            </li>
          </ul>
        ...
        <div v-show="showList==3" class="products">
          <ul>
            ...
            <li v-for="(item,index) in productDef.attList">
              <p>{{item.attName}}</p>
              <SwitchBox
                v-if="item.attCode != 'amount' && item.attCode != 'premium' && item.attCode != 'piece'"
                :optionList="item.attValueList"
                v-model="proposalPlan.insurantProductList[0].productList[0][item.attCode]"
                @change="chooseMainItem"
              ></SwitchBox>
              <p
                v-if="item.attCode == 'amount' || item.attCode == 'premium' || item.attCode == 'piece'"
            ...
            <li v-if="productDef.autoXubao !=''">
              <p>是否自动续保</p>
              <SwitchBox
                :optionList="productDef.autoXubao"
                v-model="proposalPlan.insurantProductList[0].productList[0].isAutoXubao"
                @change="chooseMainItem"
              ></SwitchBox>
            </li>
            <!--红利领取方式特殊判断-->
            <li v-if="productDef.dividend !=''">
              <p>红利领取方式</p>
              <SwitchBox
                :optionList="productDef.dividend"
                v-model="proposalPlan.insurantProductList[0].productList[0].dividend"
                @change="chooseMainItem"
              ></SwitchBox>
            </li>
            <!--生存金领取方式特殊判断-->
            <li v-if="productDef.survival !=''">
              <p>生存金领取方式</p>
              <SwitchBox
                :optionList="productDef.survival"
                v-model="proposalPlan.insurantProductList[0].productList[0].survival"
                @change="chooseMainItem"
              ></SwitchBox>
            </li>
            <!--设定自动垫交特殊判断-->
            <li v-if="productDef.isCanAutoPay !=''">
              <p>是否设定可自垫</p>
              <SwitchBox
                :optionList="[{'code':'0','text':'否'},{'code':'1','text':'是'}]"
                v-model="proposalPlan.insurantProductList[0].productList[0].isCanAutoPay"
                @change="chooseMainItem"
              ></SwitchBox>
            </li>
            <!--被保人是否有社保-->
            <li v-if="productDef.social !=''">
              <p>被保人是否有社保</p>
              <SwitchBox
                :optionList="productDef.social"
                v-model="proposalPlan.insurantProductList[0].productList[0].shebao"
                @change="chooseMainItem"
              ></SwitchBox>
            </li>
            <!--可选责任-->
            <li v-if="productDef.zerenList !=''" style="padding: 2% 4%;">
              <p>可选责任</p>
              <SwitchMultipleBox
                :optionList="productDef.zerenList"
                v-model="proposalPlan.insurantProductList[0].productList[0].zerenList"
                @change="chooseMainItem"
              ></SwitchMultipleBox>
            </li>
          ...
          <!--可选计划列表-->
          <div
            v-show="extraproductDef.length>0"
            style="width: 100%;padding: 7% 5% 20%;box-sizing: border-box;"
          >
            <div class="kexuanList">
              ...
              <div class="content" v-for="(item,index) in extraproductDef">
                <div>
                  <p
                    @click="chooseExtraList(item.productCode,item.insurantNo)"
                  >{{index + 1}} . {{item.productName}}</p>
                  <p
                    v-show="otherInsurantList.length>0"
                  >第{{item.insurantNo|getInsNo}}被保人 &nbsp;&nbsp; {{item.insurantName}}</p>
                ...
                <i
                  ...
                  :class="[item.productCode == productDef.bindCode?'gray':'']"
                ></i>
              </div>
            </div>
          </div>
      ...
      <FooterBar v-show="showList!=3">
        <div slot="center" v-preventReClick="3000" @click.prevent="stepSave($event)">下一步</div>
      </FooterBar>
      <FooterBars v-show="showList==3" :premium="totalPremium">
        <div slot="right" v-preventReClick="3000" @click.prevent="stepSave($event)">生成建议书</div>
      </FooterBars>
    </div>
    <!--附加险弹框-->
    <mt-popup v-model="toggle.extraEdit" position="center" class="additional_extraEditList">
      ...
      <div class="eject-contents">
        <ul>
          <li
            v-if="extra.productCode!='HDT042' && extra.productCode!='HDT044' && otherInsurantList.length > 0"
          >
            <p>选择被保人</p>
          ...
          <li v-for="(item,index) in extra.attList">
            ...
            <SwitchBox
              v-if="item.attCode != 'amount' && item.attCode != 'premium' && item.attCode != 'piece'"
              :optionList="item.attValueList"
              v-model="extraEdit[item.attCode]"
              @change="chooseExtraItem(item)"
            ></SwitchBox>
            <input
              type="text"
              v-if="item.attCode == 'piece'"
            ...
            <input
              type="text"
              v-if="item.attCode == 'amount'||item.attCode == 'premium'"
              v-model="extraEdit[item.attCode]"
          ...
          <li
            v-if="extra.productDefine !=undefined && extra.productDefine.zeren5 !=''"
            style="padding: 2% 4%;"
          >
            <p>可选责任</p>
            <SwitchMultipleBox
              :optionList="extra.productDefine.zeren5"
              v-model="extraEdit.zerenListOld"
            ></SwitchMultipleBox>
          </li>
        </ul>
        <!--增利宝追加保费-->
        <ul
          v-if="extra.productCode == 'NPU012' || extra.productCode == 'NPU015'"
        ...
        >
          <li>
            ...
            <input
              type="text"
              v-supportNumber
              v-model="item.addBegin"
              placeholder="起始年限" maxlength="2"
        ...
        >
          <li class="border_top">
            ...
            <input
              type="text"
              v-supportNumber
              v-model="item.drawBegin"
              placeholder="起始年限" maxlength="2"
              v-if="drawList.length == 1"
            />
	...
	export default {
				...
				this.getProductDef(this.productCode)
					...
					if(extraproductDef.length > 0) {
						for(let i = 0; i < extraproductDef.length; i++) {
							...
							if(extraproductDef[i].extra.zerenList != undefined && extraproductDef[i].extra.zerenList.length > 0) {
					...
					console.log("insurantItem==>>", this.insurantItem)
					if(this.showList == 3) {
		...
		* */
        ...
        range.select()
			...
			detailBack() {
				if(this.showList == 1) {
					this.$router.push("/proposal/prolist")
			...
			saveProposal() {
				let newProposalPlan = this.changeProposalPlan()
				newProposalPlan.holder.birthday += 'T00:00:00.000Z'
				newProposalPlan.insurantProductList[0].insurant.birthday += 'T00:00:00.000Z'
				if(this.otherInsurantList.length > 0) {
					for(let i in newProposalPlan.insurantProductList[0].otherInsurantList) {
						newProposalPlan.insurantProductList[0].otherInsurantList[i].insurant.birthday += 'T00:00:00.000Z'
					}
				}
				let requ = {
					proposalPlan: newProposalPlan
				}
				let mainPayPeriod = requ.proposalPlan.insurantProductList[0].productList[0].payPeriod
				for(let i in requ.proposalPlan.insurantProductList[0].productList[0].extraList) {
					requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].code = (parseInt(i) + 1).toString()
					if(requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].productCode == "HDT042" || requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].productCode == "HDT044") {
						if(mainPayPeriod.indexOf("term_") != -1) {
							requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].payPeriodName = (mainPayPeriod.replace("term_", "") - 1) + "年"
							// requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].policyPeriodName = mainPayPeriod.replace("term_", "")+"年"
							requ.proposalPlan.insurantProductList[0].productList[0].extraList[i].policyPeriodName = "保终身"
						}
					}
				}
				if(requ.proposalPlan.insurantProductList[0].otherInsurantList.length > 0) {
					for(let item of requ.proposalPlan.insurantProductList[0].otherInsurantList) {
						for(let extea of item.extraList) {
							if(extea.productCode == 'HDT042' || extea.productCode == 'HDT044') {
								if(mainPayPeriod.indexOf("term_") != -1) {
									extea.payPeriodName = (mainPayPeriod.replace("term_", "") - 1) + "年"
									extea.policyPeriodName = "保终身"
								}
							}
						}
					}
				}
				console.log('==========================保存建议书requ=======', requ)
				utils.http.post('PROPOSALSAVE', requ).then(response => {
					utils.cache.set('proposalPlan', this.changeProposalPlan())
					this.$router.push({
						name: "proposalDemo",
						params: {
							planId: this.planId
...
.main-contents {
  .sheet_a {
    ...
    background: url("./../../../static/img/policy/icon_a.png") no-repeat center
      center #f0f0f0;
  ...
  .sheet_b {
    background: url("./../../../static/img/policy/icon_b.png") no-repeat center
      center #f0f0f0;
    background-size: 100% 100%;
    p:nth-child(2) {
      color: #feb101;
  ...
  .sheet_c {
    background: url("./../../../static/img/policy/icon_c.png") no-repeat center
      center #f0f0f0;
    background-size: 100% 100%;
    p {
      color: #feb101;
