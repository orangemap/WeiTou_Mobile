...
function anysignCommentUI() {
	...
	this.onload_commentSignCanvas = function(obj) {
		commentObjTmp = obj;
		...
		new anysignCommentCore(inner_string, line_count, commentObjTmp);
	...
	function loadView() {
		...
		if(window.orientation == 0 || window.orientation == 180) { //竖屏
			...
			document.getElementById("signImage").style.height = getWindowHeight() * 0.7 - document.getElementById("comment_title").offsetHeight; // getWindowHeight() * 0.6 + "px";
