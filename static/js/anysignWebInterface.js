...
document.write("<link href=\"static/css/canvas_css.css\" rel=\"stylesheet\">");
document.write("<link href=\"static/css/sp.css\" rel=\"stylesheet\">");

document.write("<link media=\"screen and (max-width: 480px)\" href=\"static/css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 480px) and (max-width: 1024px)\" href=\"static/css/mw480Portrait.css\" rel=\"stylesheet\">");
document.write("<link media=\"screen and (min-width: 1024px)\" href=\"static/css/sw1024.css\" rel=\"stylesheet\">");

document.write("<script language=javascript src=\"static/lib/zlib/deflate.min.js\" charset=\"utf-8\"></script>");

document.write("<script language=javascript src=\"static/lib/CryptoJS v3.1.2/components/core-min.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\"static/lib/CryptoJS v3.1.2/rollups/sha1.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\"static/lib/CryptoJS v3.1.2/rollups/tripledes.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\"static/lib/CryptoJS v3.1.2/components/mode-ecb.js\" charset=\"utf-8\"></script>");

document.write("<script language=javascript src=\"static/lib/anysignCommentUI.js\" charset=\"utf-8\"></script>");
document.write("<script language=javascript src=\"static/lib/anysign_all.js\" charset=\"utf-8\"></script>");
...
function AnySignApi()
{
	...
	*/
	...
	{
		return "AnySign_V1.3.3_Web_2.2.0.33614";
	}
...
function SignatureConfig(signer, signRule)
{
   ...
   // this.title = "本人已阅读保险条款、产品说明书和投保提示书，了解本产品的特点和保单利益的不确定性。";//批示输入有效，批示内容
    this.cid = 0;//手写签名对象索引值
    this.title = "请投保人签名";//签字输入有效，签字框标题
    ...
    this.isTSS = false;//是否开启 时间戳，默认为false
...
function CommentConfig(signer, signRule)
{
    ...
    this.signer = signer;//签名人信息，为必填项
    this.signRule = signRule;//签名放置到文档中的规则，如位置，大小等，为必填项
    this.cid = 30;//手写签名对象索引值
    this.commitment = "本人已阅读保险条款、产品说明书和投保提示书，了解本产品的特点和保单利益的不确定性。";//批注内容
    this.mass_words_in_single_line = 25;//生成的签名图片中单行显示的字数
    this.mass_word_height = 75;//生成的签名图片中单个字的高
    this.mass_word_width = 50;//生成的签名图片中单个字的宽
    this.isTSS = false;//是否开启 时间戳，默认为false
    this.penColor = "#000000";//RGB，默认为黑色，每通道为0~255的16进制值，如#ffffff为白色
    this.nessesary = false;//是否为必签项,设置为true时必须进行签名
